...
// ---------------------------------------------------------------------------
// Validation unit tests — no real git needed
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Integration test — requires git in PATH
// ---------------------------------------------------------------------------
...
describe("gitro integration — execute real git command", () => {
  ...
  test("runs 'status' in a fresh git repo and returns ok:true", async () => {
    // Create a temp directory and initialise a git repo
    ...
    try {
      ...
      // Dynamically import the tool so it runs in the test process
