...
Before finishing a debug fix:

- Original failure is reproduced or evidence explains why it cannot be.
- Root cause is supported by code, logs, tests, or a falsified alternative.
- Fix is minimal and does not hide the symptom.
- Original failing command and nearby regression coverage pass or are noted.
